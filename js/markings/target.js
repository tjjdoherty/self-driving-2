class Target extends Marking { // stop is going to be a polygon that sits on top of the road
    ...
    draw(ctx) {
        ...
        ctx.fillText("Target", 0, 1); // 0,1 are coordinates of where to put the fill text but we translate/rotate/scaled above, so nothing here just 1 in y for very slight adjustment/offset.
